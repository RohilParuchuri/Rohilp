...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
              Hi, I'm <span className="bg-gradient-to-r from-amber-700 to-stone-700 bg-clip-text text-transparent">Rohil Paruchuri</span>
            </h1>
              ...
              {session ? (
                <>
                  ...
                  <a
                    ...
                    className="px-6 py-4 bg-amber-700 text-white font-semibold rounded-lg hover:bg-amber-600 transition transform hover:scale-105"
                  >
                    LinkedIn
                  </a>
                </>
                ...
                <Link
                  href="/signin"
                  className="px-8 py-4 bg-stone-700 text-white font-semibold rounded-lg hover:bg-stone-600 transition transform hover:scale-105"
                >
                  Sign In
                </Link>
              )}
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl overflow-hidden shadow-xl shadow-slate-900/40 ring-2 ring-stone-600/30">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-amber-900/15 to-stone-900/15">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-black/40 backdrop-blur p-8 rounded-xl border border-amber-600/30 hover:border-amber-600 transition">
              <div className="text-5xl mb-4">🏐</div>
            ...
            <div className="bg-black/40 backdrop-blur p-8 rounded-xl border border-slate-600/30 hover:border-slate-600 transition">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              {session ? (
                ...
                <>
                  <Link
                    href="/signin"
                    className="px-8 py-4 bg-gradient-to-r from-stone-700 to-amber-700 text-white font-semibold rounded-lg hover:from-stone-600 hover:to-amber-600 transition transform hover:scale-105"
                  >
                    Sign In
                  </Link>
                  <Link
                    href="/signup"
                    className="px-8 py-4 bg-transparent border-2 border-amber-700 text-white font-semibold rounded-lg hover:bg-amber-700 transition transform hover:scale-105"
                  >
                    Create Account
                  </Link>
                </>
