      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-[320px,1fr] gap-10 mb-12">
          <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden shadow-lg">
            <div className="relative aspect-square max-w-[220px] mx-auto bg-gradient-to-br from-amber-900/60 to-stone-900/40 flex items-center justify-center">
              <div className="absolute inset-4 rounded-2xl bg-black/30 backdrop-blur" />
              <div className="absolute inset-0 animate-pulse bg-gradient-to-b from-amber-600/10 via-stone-600/5 to-transparent" />
              <div className="relative w-[88%] h-[88%] rounded-2xl overflow-hidden shadow-xl shadow-slate-900/40 ring-2 ring-stone-600/30 hover:scale-[1.02] transition-transform duration-300">
            ...
            {session && (
              <div className="mt-4">
                <a
                  ...
                  className="inline-block px-4 py-2 bg-amber-700 hover:bg-amber-600 text-white rounded-lg text-sm transition"
                >
                  Connect on LinkedIn
                </a>
              </div>
