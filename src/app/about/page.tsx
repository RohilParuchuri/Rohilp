      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-[320px,1fr] gap-10 mb-12">
          <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden shadow-lg">
            <div className="relative aspect-square max-w-[220px] mx-auto bg-gradient-to-br from-blue-900/60 to-purple-900/40 flex items-center justify-center">
              <div className="absolute inset-4 rounded-2xl bg-black/30 backdrop-blur" />
              <div className="absolute inset-0 animate-pulse bg-gradient-to-b from-blue-500/10 via-purple-500/5 to-transparent" />
              <div className="relative w-[88%] h-[88%] rounded-2xl overflow-hidden shadow-xl shadow-blue-900/40 ring-2 ring-blue-500/30 hover:scale-[1.02] transition-transform duration-300">
