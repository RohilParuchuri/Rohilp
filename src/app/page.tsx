        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
              Hi, I'm <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Rohil Paruchuri</span>
            </h1>
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl overflow-hidden shadow-xl shadow-blue-900/40 ring-2 ring-blue-500/30">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-black/40 backdrop-blur p-8 rounded-xl border border-purple-500/30 hover:border-purple-500 transition">
              <div className="text-5xl mb-4">🏐</div>
            ...
            <div className="bg-black/40 backdrop-blur p-8 rounded-xl border border-blue-500/30 hover:border-blue-500 transition">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              {session ? (
                ...
                <>
                  <Link
                    href="/signin"
                    className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-purple-700 transition transform hover:scale-105"
                  >
                    Sign In
                  </Link>
                  <Link
                    href="/signup"
                    className="px-8 py-4 bg-transparent border-2 border-purple-500 text-white font-semibold rounded-lg hover:bg-purple-500 transition transform hover:scale-105"
                  >
                    Create Account
                  </Link>
                </>
